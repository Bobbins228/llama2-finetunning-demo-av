...
def training_func():
    ...
    adapter_model = f"bobbins228/{base_model_name}-fine-tuned-adapters"  #adjust 'bobbins228' to your HuggingFace organisation
    new_model = f"bobbins228/{base_model_name}-fine-tuned" #adjust 'bobbins228' to your HuggingFace organisation
